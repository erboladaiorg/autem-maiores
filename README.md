# @erboladaiorg/autem-maiores

![Test](https://github.com/erboladaiorg/autem-maiores/workflows/Test/badge.svg)
[![codecov](https://codecov.io/gh/vega/@erboladaiorg/autem-maiores/branch/master/graph/badge.svg)](https://codecov.io/gh/vega/@erboladaiorg/autem-maiores)
[![npm version](https://img.shields.io/npm/v/@erboladaiorg/autem-maiores.svg)](https://www.npmjs.com/package/@erboladaiorg/autem-maiores)
...
This project is made possible by a [community of contributors](https://github.com/erboladaiorg/autem-maiores/graphs/contributors). We welcome contributions of any kind (issues, code, documentation, examples, tests,...). Please read our [code of conduct](https://vega.github.io/vega/about/code-of-conduct).
...
```bash
npx @erboladaiorg/autem-maiores --path 'my/project/**/*.ts' --type 'My.Type.Name'
```

Or install the package and then run it

```bash
npm install --save @erboladaiorg/autem-maiores
./node_modules/.bin/@erboladaiorg/autem-maiores --path 'my/project/**/*.ts' --type 'My.Type.Name'
```
...
const tsj = require("@erboladaiorg/autem-maiores");
const fs = require("fs");

/** @type {import('@erboladaiorg/autem-maiores/dist/src/Config').Config} */
const config = {
...
import { BaseType, Definition, FunctionType, SubTypeFormatter } from "@erboladaiorg/autem-maiores";
...
```ts
import { createProgram, createParser, SchemaGenerator, createFormatter } from "@erboladaiorg/autem-maiores";
...
import { Context, StringType, ReferenceType, BaseType, SubNodeParser } from "@erboladaiorg/autem-maiores";
// use typescript exported by TJS to avoid version conflict
import ts from "@erboladaiorg/autem-maiores";
...
-   PRs made into the default branch are auto-deployed to the `next` pre-release tag on NPM. The result can be installed with `npm install @erboladaiorg/autem-maiores@next`
    -   When merging into `next`, please use the `squash and merge` strategy.
-   To release a new stable version, open a PR from `next` into `stable` using this [compare link](https://github.com/erboladaiorg/autem-maiores/compare/stable...next).
